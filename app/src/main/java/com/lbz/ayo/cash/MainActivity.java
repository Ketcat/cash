...
import com.lbz.ayo.cash.activity.BasicActivity;
import com.lbz.ayo.cash.bean.IntegralBean;
import com.lbz.ayo.cash.bean.VersionBean;
import com.lbz.ayo.cash.fragment.CertificationFragment;
import com.lbz.ayo.cash.fragment.LoanFragment;
import com.lbz.ayo.cash.fragment.MineFragment;
import com.lbz.ayo.cash.utils.Contants;
import com.lbz.ayo.cash.utils.PhoneInfo;
import com.lbz.ayo.cash.utils.SharedPreUtil;
import com.lbz.ayo.cash.utils.StatusBarUtils;
import com.lbz.ayo.cash.view.LoadingCustom;
import com.lbz.ayo.cash.view.NoScrollViewPager;
                        ...
                        try {
                            ...
                            if (!TextUtils.isEmpty(integralBean.getError())) {
                                if ("err.auth.access.denied".equals(integralBean.getError())) {
                                    ...
                                    SharedPreUtil.saveBoolean(mContext, SharedPreUtil.ISLOGIN,
                                            false);
